...
ALL_OBJECTS =  $(BDIR)/cd.o $(BDIR)/echo.o $(BDIR)/execute.o $(BDIR)/exit.o $(BDIR)/handlers.o $(BDIR)/ls.o $(BDIR)/pcwd.o $(BDIR)/pinfo.o $(BDIR)/shi.o $(BDIR)/signal_handlers.o $(BDIR)/utils.o
...
$(BDIR)/shi.o: $(SDIR)/shi.c $(IDIR)/shi.h $(IDIR)/common.h $(IDIR)/constants.h $(IDIR)/execute.h $(IDIR)/handlers.h $(IDIR)/signal_handlers.h $(IDIR)/types.h $(IDIR)/utils.h
	$(CC) $(CFLAGS) -I$(IDIR) -c $(SDIR)/shi.c -o $(BDIR)/shi.o

$(BDIR)/signal_handlers.o: $(SDIR)/signal_handlers.c $(IDIR)/signal_handlers.h $(IDIR)/common.h $(IDIR)/utils.h
